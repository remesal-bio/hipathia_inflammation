## SCRIPT 3. Limpieza, filtrado, estandarización y normalización de la base de datos de GTEx.
## y cálculo de la matriz de activación de los circuitos de la inflamación
...
# Limpiamos los identificadores de genes en la columna 'Name' del dataframe 'datos'. La función 'sub' se usa para 
